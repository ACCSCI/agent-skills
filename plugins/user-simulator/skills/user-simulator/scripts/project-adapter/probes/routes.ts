...
import type { ProbeContribution, RouteType } from "../types.js";

const MAX_ENTRIES = 200;

export function probeRoutes(root: string): ProbeContribution {
...
function walk(dir: string, rel: string, out: string[], depth: number): void {
  if (depth > 4 || out.length >= MAX_ENTRIES) return;
